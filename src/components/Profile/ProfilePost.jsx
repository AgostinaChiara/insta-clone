...
const ProfilePost = ({post}) => {
  ...
  return (
    <>
      <GridItem cursor={"pointer"} borderRadius={4} overflow={"hidden"} border={"whiteAlpha.300"} position={"relative"} aspectRatio={1/1} onClick={onOpen}>
      ...
      >
        ...
        <ModalContent>
          ...
          <ModalBody bg={"black"} pb={5}>
            <Flex gap={5} w={{base:"90%",sm:"70%",md:"full"}} mx={"auto"} maxH={"90vh"} minH={"50vh"}> 
